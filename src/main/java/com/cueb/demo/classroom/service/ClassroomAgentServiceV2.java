...
/**
 * V2 版本的 Agent Service —— 与 V1 功能相同，但额外将 VO 数据写入
 * {@link ClassroomQueryContext}，供 Controller 在 AI 调用结束后取出返回给前端。
 */
@Service
public class ClassroomAgentServiceV2 {
    ...
    public ClassroomAgentServiceV2(ClassroomService classroomService,
    ...
    public String queryClassrooms(
        ...
        // V2 新增：暂存 VO 到 request 上下文，供 Controller 读取
        context.setLastQueryResult(list);
